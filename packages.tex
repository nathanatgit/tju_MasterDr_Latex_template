...
\usepackage{emptypage}      % remove page numbers in the blank page
...
% explains: the documentclass uses twoside to maintain margins on even/odd pages, while the geometry package would swap left and odd pages.
% This contradicts the requirement of the thesis template (while not to my agreement. Obviously you need to switch odd and even page margins for printing, but the template requires a fixed margin).
