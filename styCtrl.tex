...
%% Define Chinese control sequences for font sizes (temporarily use). Remove unnecessary if you don't need it.
% The first means the font size, and the second means the line height
...
\newcommand{\initfont}{                     % command for setting font size and line height
